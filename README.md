...
*   **🗣️ Multilingual Voice Interaction**: Ask questions directly by recording your voice live or by uploading an audio file. The system automatically detects and processes your query.
*   **🧠 Intelligent RAG Engine**: Utilizes **FAISS** and Sentence Transformers for ultra-fast, context-aware information retrieval from vector databases.
...
*   **🔊 Real-time Text-to-Speech (TTS)**: Converts the AI-generated responses back to natural-sounding audio using, featuring adjustable voice playback speeds (0.5x to 2.0x).
...
- **Text-to-Speech (TTS)**: Google Text-to-Speech
